...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
  ...
  public void onCreate(Bundle icicle) {
    ...
    // Objects.requireNonNull(getActionBar()).setTitle(getString(R.string.menu_title_codescan));
  ...
  private void handleDecodeExternally(Result rawResult, Bitmap barcode) {
    ...
    statusView.setText(R.string.qrscan_complete);
  ...
  private void displayFrameworkBugMessageAndExit() {
    ...
    builder.setMessage(R.string.qrscan_error);
    builder.setPositiveButton(R.string.qrscan_button, new FinishListener(this));
  ...
  private void resetStatusView() {
    ...
    statusView.setText(R.string.qrscan_info);
